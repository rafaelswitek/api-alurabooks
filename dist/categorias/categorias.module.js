...
const categorias_resolver_1 = require("./resolvers/categorias.resolver");
...
CategoriasModule = __decorate([
    (0, common_1.Module)({
        providers: [categorias_service_1.CategoriasService, categorias_resolver_1.CategoriasResolver],
    })
], CategoriasModule);
